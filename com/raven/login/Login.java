...
public class Login extends javax.swing.JFrame {
    ...
    String email = myTextField1.getText();
    String password = new String(myPassword1.getPassword());
    String type = "";
    ...
    private void authenticateUser(String email, String password, String type) {
    // Perform authentication logic here
    // You can check the email, password, and type against a database or any other authentication mechanism
    // If the authentication is successful, you can proceed with the login process
    // Otherwise, display an error message
    
    // Example logic with MySQL database:
    String sql = "SELECT * FROM resident(login) WHERE email = ? AND password = ? AND type = ?";
